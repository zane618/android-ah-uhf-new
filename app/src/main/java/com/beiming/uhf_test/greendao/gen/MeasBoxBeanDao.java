...
public class MeasBoxBeanDao extends AbstractDao<MeasBoxBean, Long> {
    ...
    public static class Properties {
        ...
        public final static Property FenzhixAssetNo = new Property(20, String.class, "fenzhixAssetNo", false, "FENZHIX_ASSET_NO");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MEAS_BOX_BEAN\" (" + //
                ...
                "\"FENZHIX_ASSET_NO\" TEXT," + // 20: fenzhixAssetNo
    ...
    protected final void bindValues(DatabaseStatement stmt, MeasBoxBean entity) {
        ...
        String fenzhixAssetNo = entity.getFenzhixAssetNo();
        if (fenzhixAssetNo != null) {
            stmt.bindString(21, fenzhixAssetNo);
        }
    ...
    public MeasBoxBean readEntity(Cursor cursor, int offset) {
        MeasBoxBean entity = new MeasBoxBean( //
            ...
            cursor.isNull(offset + 20) ? null : cursor.getString(offset + 20), // fenzhixAssetNo
    ...
    public void readEntity(Cursor cursor, MeasBoxBean entity, int offset) {
        ...
        entity.setFenzhixAssetNo(cursor.isNull(offset + 20) ? null : cursor.getString(offset + 20));
